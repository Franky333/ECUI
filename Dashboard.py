...
class Dashboard(QWidget):
	def __init__(self, parent=None):
		...
		self.countdownTimer = CountdownTimer(self.countdownEvent, -10, 0.1)
		...
		self.btn_countdownStartStop.setStyleSheet('background-color: #00AA00;')
		...
		self.slider_manualControlFuel.valueChanged.connect(self.manualControlFuelChange)
		...
		self.slider_manualControlOxidizer.valueChanged.connect(self.manualControlOxidizerChange)
		...
		self.btn_saftl = QPushButton("Saftl", self)
		self.btn_saftl.clicked.connect(self.saftlPressed)
		self.btn_saftl.setCheckable(True)
		...
		self.layout_manualControl.addWidget(self.btn_saftl)
	...
	def saftlPressed(self):

		if self.btn_saftl.isChecked():
			self.slider_manualControlFuel.setValue(100)
			self.slider_manualControlOxidizer.setValue(100)
		else:
			self.slider_manualControlFuel.setValue(0)
			self.slider_manualControlOxidizer.setValue(0)
	...
	def countdownStartStopReset(self):
		if self.btn_countdownStartStop.text() == "Start":
			...
			self.btn_countdownStartStop.setStyleSheet('background-color: #AA0000;')
			...
			self.countdownEvent()
			self.label_countdownClock.setStyleSheet('color: #FF8888')
			...
			self.btn_countdownStartStop.setStyleSheet('background-color: #888888;')
			...
			self.countdownEvent()
			self.label_countdownClock.setStyleSheet('color: #FFFFFF')
